...
<head>
    ...
    <title>Blog posts - Explore the Space</title>
...
<svg class="svg-planet" viewBox="0 0 180 100">
    ...
    <ellipse cx="140" cy="30" rx="50" ry="12" fill="none" stroke="#fff" stroke-width="2" opacity="0.3" />
        ...
        <!-- Hero Sect-->
        <section class="hero">
            <div class="hero-title">WELCOME IN YOUR<br />SyntaxSpace</div>
            <div class="hero-desc">
                A playground to learn HTML, CSS, JS, and PHP through a real-world blog projec.
            </div>
        </section>
...
<div class="posts-container">
    ...
    ?>
        <div class="post-card">
            ...
            <p><?= htmlspecialchars(mb_strimwidth($post['content'], 0, 120, "...")) ?></p>
